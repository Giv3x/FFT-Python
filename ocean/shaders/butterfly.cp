...
layout (rgba32f, binding = 3) uniform image2D twiddlesIndices;

layout (rgba32f, binding = 2) uniform image2D pingpong0;

layout (rgba32f, binding = 5) uniform image2D pingpong1;
